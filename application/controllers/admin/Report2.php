...
class Report2 extends MY_Controller {
	 ...
	 public function index()
    {
        ...
        $this->middle = 'admin/r2/election_process2';
        $this->admin();
    }
    ...
    public function election_process1()
    {
        ...
        $this->middle = 'admin/r2/election_process1';
        $this->admin();
    }
     ...
     public function election_process3()
    {
        ...
        $this->middle = 'admin/r2/election_process3';
        $this->admin();
    }
