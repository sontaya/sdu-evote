...
ul.custom-tab li a.active {
    color: #4125dd;
                ...
                <form action="" method="POST" id="form_vote">
                 ...
                 <ul class="nav custom-tab nav-fill" id="myTab" role="tablist">
                    <li class="nav-item rounded-top" style="background-color:#68CEF5;">
                        <a class="nav-link active show" id="home1-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home1" aria-selected="true">1.กรรมการสภามหาวิทยาลัย จากพนักงานมหาวิทยาลัย สายสนับสนุน<br> (เลือกผู้สมัครได้ 2 คน)</a>
                    </li>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active show" id="home" role="tabpanel" style="background-color:#68CEF5;">
...
<div class="row">
                  ...
                  <div class="col-md-12 text-center pb-3">
                     <a href="javascript:validate2('#home2');" class="btn btn-success">หน้าถัดไป <i class="fas fa-arrow-right"></i></a>
          <!--  <input type="button" class="btn btn-success" value = "หน้าถัดไป" onclick = "return validate2('#home2');" />-->
...
<div class="row">
                  ...
                  <div class="col-md-12 text-center pb-3">
                   <!--   <input type="button" class="btn btn-warning" value="ย้อนกลับ" onclick="return validate1('#home2');" /> -->
                     <a href="javascript:validate1('#home2');" class="btn btn-warning"><i class="fas fa-undo"></i> ย้อนกลับ</a>
...
function validate1(tabid) {
  ...
  var checkbox10=$('.no_candidate1:checked');
    ...
    if(checkbox11.length > 0 || checkbox10.length > 0) {      
      ...
      Swal.fire({icon: 'info', title: 'กรุณาเลือกผู้สมัคร สภาคณาจารย์และพนักงาน', });
    }
}
...
function validate2(tabid) {
    ...
    if(checkbox31.length > 0 || checkbox30.length > 0) {      
      ...
      Swal.fire({icon: 'info', title: 'กรุณาเลือกผู้สมัคร กรรมการสภามหาวิทยาลัย จากพนักงานมหาวิทยาลัย สายสนับสนุน', });
