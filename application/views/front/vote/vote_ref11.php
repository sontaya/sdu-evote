                 ...
                 <ul class="nav custom-tab nav-fill" id="myTab" role="tablist">
                  <li class="nav-item rounded-top" style="background-color:#B39F62;">
                    ...
                    <li class="nav-item rounded-top" style="background-color:#F873BA;">
                        <a class="nav-link" id="home2-tab" data-toggle="tab" href="#home2" role="tab" aria-controls="home2" aria-selected="false">1.กรรมการสภามหาวิทยาลัย
...
<div class="row">
            ...
            <input type="button" class="btn btn-success" value = "หน้าถัดไป" onclick = "return validate1('#home');" />
               ...
               <!-- /////  -->
                 ...
                 <div class="tab-pane fade" id="home2" role="tabpanel" aria-labelledby="home2-tab" style="background-color:#F873BA;">
                ...
                <tr id="ck02">
                  <td style="vertical-align:middle;text-align:center;">
                  <input type="checkbox"  class="d-none no_candidate2 imgbgchk" name="candidate_id2[]" data-c_num="0" value="0" id="chk_002" />
                    <label for="chk_002">
                          <img src="<?php echo base_url('uploads/img/vote2.jpg');?>" alt="Image0" width="50px">
                          <div class="tick_container">
                            <div class="tick"><i class="fa fa-times" aria-hidden="true" ></i></div>
...
function validate2(tabid) {
    ...
    if(checkbox21.length > 0 || checkbox20.length > 0) {      
      ...
      Swal.fire({icon: 'info', title: 'คุณยังไม่ได้เลือก กรรมการสภามหาวิทยาลัย จากคณาจารย์ประจำ', });
...
//group 2
    $("input:checkbox.candidate2").click(function() {
     $('.no_candidate2').attr('disabled', true);
      ...
      var cnklen2 = $('.candidate2:checked').length;
      //console.log(cnklen3);
      if(cnklen2 > 2 ){
        Swal.fire({
          icon: 'error',
        ...
        for (var checkbox2 of markedCheckbox2) {
          console.log("ck2: " +checkbox2.value);
  ...
  $("input:checkbox.no_candidate2").click(function() {      
      if(!$(this).is(":checked")){
        $('.candidate2').attr('disabled', false);
...
//group 1
  $("input:checkbox.candidate1").click(function() {
      ...
      if(cnklen1 > 19 ){
       ...
       // document.getElementById('vdata2').innerHTML = "";
        for (var checkbox1 of markedCheckbox1) {
          console.log("ck1: " +checkbox1.value);
    ...
    $("#submit2").click(function() {
      ...
      var checkbox21 =$('input[name="candidate_id2[]"]:checked');
     
      if((checkbox11.length > 0) && (checkbox21.length > 0)){
