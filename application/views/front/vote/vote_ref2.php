...
ul.custom-tab li a.active {
    color: #4125dd;
                ...
                <tr id="ck03">
                  <td style="vertical-align:middle;text-align:center;">
                  <input type="checkbox"  class="d-none no_candidate3 imgbgchk" name="no_candidate3" data-c_num="0" value="0" id="no_candidate3" />
...
//group 1
  $("input:checkbox.candidate1").click(function() {
    ...
    $("#submit2").click(function() {
      ...
      var checkbox31 =$('.candidate3:checked');
      var checkbox30=$('.no_candidate3:checked');
      if((checkbox11.length > 0 || checkbox10.length > 0) && (checkbox31.length > 0 || checkbox30.length > 0)){
