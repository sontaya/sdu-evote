	...
	<section class="content">
		<div class="row">
			<div class="col-lg-6">
                 ...
                 <a href="<?php echo site_url('admin/report/print11');?>" class="btn btn-primary">พิมพ์</a>
			        </div>
			...
			<div class="col-lg-6">
				<div class="card">
                 ...
                 <a href="<?php echo site_url('admin/report/print12');?>" class="btn btn-primary">พิมพ์</a>
			        </div>
