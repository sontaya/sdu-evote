                  ...
                  <tbody>
                     ...
                     foreach ($events as $key => $r){ ?>
                      ...
                      <td><?php echo $r->event_name;?></td>
                        <td style="vertical-align:middle;text-align:center;"><?php echo $r->st_date;?></td>
                        <td>
                        <?php echo $r->en_date;?>
                        ...
                        <td style="vertical-align:middle;text-align:center;">
                          ...
                          <a class="btn btn-info btn-sm btn-edit" href="#" data-id="<?= $r->id;?>" data-candidate_name="<?= $r->event_name;?>" data-department="<?= $r->st_date;?>" data-c_number="<?= $r->en_date;?>"  data-status="<?= $r->status;?>">
