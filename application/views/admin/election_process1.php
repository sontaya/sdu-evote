      ...
      <div class="container-fluid">
        ...
        <div class="row" id="tbl_score1">
          <div class="col-lg-6">
              <div class="card">
                <div class="card-header">
                   <h3 class="card-title">ประกาศผลคะแนนการเลือกตั้งสภาคณาจารย์และพนักงาน(คณาจารย์)</h3>
          ...
          <div class="col-lg-6">
              <div class="card">
                <div class="card-header">
                   <h3 class="card-title">ประกาศผลคะแนนการเลือกตั้งสภาคณาจารย์และพนักงาน(พนักงาน)</h3>
