  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ประกาศผลคะแนนการเลือกตั้งสภาคณาจารย์และพนักงาน</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="row" id="tbl_score1">
          <div class="col-lg-6">
              <div class="card">
                <div class="card-header">
                   <h3 class="card-title">ประกาศผลคะแนนการเลือกตั้งสภาคณาจารย์และพนักงาน(อาจารย์ประจำ)</h3>
              ...
              <div class="card-body p-0">
                ...
                <table class="table table-bordered" id="desktop1" style="width:100%">
                  <thead>
                    <tr>
          ...
          <div class="col-lg-6">
              <div class="card">
                <div class="card-header">
                   <h3 class="card-title">ประกาศผลคะแนนการเลือกตั้งสภาคณาจารย์และพนักงาน(พนักงานมหาวิทยาลัย)</h3>
              ...
              <!--  <button id="but" type="button" class="btn btn-danger" onclick='redirect_Page(this)'>ประกาศผลคะแนน1</button>-->
                ...
                <table class="table table-bordered" id="desktop2" style="width:100%">
                  <thead>
                    <tr>
        ...
        <div class="row p-3" id="result">
           <div class="col-lg-12 text-center">
              ...
              <a href="<?php echo base_url();?>admin/report/election_rept1" class="btn btn-primary">สรุปผลการเลือกตั้ง</a>
              ...
              preConfirm: () => {
               ...
               allowOutsideClick: () => !Swal.isLoading()
                ...
                if(result.value){
                  ...
                  $.ajax({
                    url: baseurl + 'admin/report/process_score11',
                    type: 'GET',
                    success: function(data){                     
                      ...
                      for (var i = 0; i < obj.length; i++) {          
                       ...
                       html += '<td style="vertical-align:middle;text-align:center;">'+obj[i].score_order1+'</td></tr>';
                       }
                    
                       
                       setTimeout(function() {
                         $("#tbl_score1").show();
                        $("#desktop1 tbody").html(html);
                         $("#result").show(); 
                      }, 4000);   
                      $('#button').hide();   
                  ...
                  $.ajax({
                    url: baseurl + 'admin/report/process_score12',
                    type: 'GET',
                    success: function(data){                     
