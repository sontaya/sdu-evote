 <div class="content-wrapper">
	<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>ผลการเลือกตั้งสภาคณาจารย์และพนักงาน</h1>
          </div>
          <div class="col-sm-6">
	...
	<section class="content">
		<div class="row">
			<div class="col-lg-6">
				 <div class="card">
			        <div class="card-header">
			          <h3 class="card-title">ประกาศผลการเลือกตั้ง(อาจารย์ประจำ)</h3>
			        				...
			        				<?php 
                     				...
                     				foreach ($score1 as $key => $r){ ?>
                     					<tr>
                     						...
                     						<td valign="center" class="text-center"><strong><?php echo $r->c_number; ?></strong></td>
                     						<td><img src="<?php echo base_url();?>uploads/events/<?php echo $r->picture; ?>" width="64" height="80" class="my-n1" alt=""><?php echo $r->fullname; ?></td>
                                <td valign="center" class="text-center"><?php echo $r->score; ?></td>
                     					</tr>
                     			<?php 
                     			$i += 1; 
			...
			<div class="col-lg-6">
				<div class="card">
			        <div class="card-header">
			          <h3 class="card-title">ประกาศผลการเลือกตั้ง(พนักงานมหาวิทยาลัย)</h3>			         
			        </div>
			        <div class="card-body">
			        	<div class="table-responsive">
