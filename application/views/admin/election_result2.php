	...
	<section class="content">
		<div class="row">
			<div class="col-lg-6">
			        ...
			        <div class="card-body">
                      ...
                      <th valign="center" class="text-center">คะแนน</th>
			        			...
			        			<tbody>
			        				<?php 
                     				$i=1;
                     				foreach ($score21 as $key => $r1){ ?>
                     					<tr>
                     						<td valign="center" class="text-center"><?php echo $i; ?></td>
                     						<td valign="center" class="text-center"><?php echo $r1->c_number; ?></td>
                     						<td><?php echo $r1->fullname; ?></td>
                                <td valign="center" class="text-center"><?php echo $r1->total; ?></td>
                     					</tr>
                     			<?php 
                     			$i += 1; 
                 ...
                 <a href="<?php echo site_url('admin/report/print21');?>" class="btn btn-primary">พิมพ์</a>
			        </div>
			...
			<div class="col-lg-6">
				<div class="card">
			        ...
			        <div class="card-body">
                      ...
                      <th valign="center" class="text-center">หมายเลข</th>
			        			...
			        			<tbody>
			        				<?php 
                            $i=1;
                            foreach ($score22 as $key => $r2){ ?>
                              <tr>
                                <td valign="center" class="text-center"><?php echo $i; ?></td>
                                <td valign="center" class="text-center"><?php echo $r2->c_number; ?></td>
                                <td><?php echo $r2->fullname; ?></td>
                                <td valign="center" class="text-center"><?php echo $r2->total; ?></td>
                              </tr>
                          <?php 
                          $i += 1; 
                 ...
                 <a href="<?php echo site_url('admin/report/print22');?>" class="btn btn-primary">พิมพ์</a>
			        </div>
