  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ประกาศผลคะแนนการเลือกตั้งกรรมการสภามหาวิทยาลัย จากพนักงานมหาวิทยาลัย สายสนับสนุน</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="row p-3" id="result">
           <div class="col-lg-12 text-center">
              ...
              <a href="<?php echo base_url();?>admin/report/election_rept3" class="btn btn-primary">สรุปผลการเลือกตั้ง</a>
              ...
              preConfirm: () => {
               ...
               allowOutsideClick: () => !Swal.isLoading()
                ...
                if(result.value){
                  ...
                  $.ajax({
                    url: baseurl + 'admin/report/process_score3',
                    type: 'GET',
